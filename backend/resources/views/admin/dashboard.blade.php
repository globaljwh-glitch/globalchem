 ...
 <div id="content" class="main-content">
    <div class="container">
        ...
        @if(session('error')) 
            ...
            @endif
            @if(session('success')) 
            <div class="sucess alert alert-success alert-dismissable col-md-12">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    ...
                    <div class="widget  t-sales-widget">
                        <div class="media">
                            ...
                            <div class="media-body text-right">
                                ...
                                <p class="widget-numeric-value">{{ $total_contact }}</p>
                            </div>
                        </div>
                        <!-- <p class="widget-total-stats mt-2">0 active mails</p> -->
                    </div>
                </div>
            </div>
                ...
                <div class="widget-content-area  data-widgets br-4">
                    <div class="widget  t-order-widget">
                        <div class="media">
                            ...
                            <div class="media-body text-right">
                                <p class="widget-text mb-0">Current Jobs</p>
                                <p class="widget-numeric-value">{{  $total_jobs }}</p>
                            </div>
                        </div>
                        <!-- <p class="widget-total-stats mt-2">0 active jobs</p> -->
                    </div>
                </div>
            </div>
                ...
                <div class="widget-content-area  data-widgets br-4">
                    <div class="widget  t-customer-widget">
                        <div class="media">
                            ...
                            <div class="media-body text-right">
                                <p class="widget-text mb-0">GCC News</p>
                                <p class="widget-numeric-value">{{ $total_news }}</p>
                            </div>
                        </div>
                        <!-- <p class="widget-total-stats mt-2">0 active news</p> -->
                    </div>
                </div>
            </div>
                ...
                <div class="widget-content-area  data-widgets br-4">
                    <div class="widget  t-income-widget">
                        <div class="media">
                            ...
                            <div class="media-body text-right">
                                <p class="widget-text mb-0">Job Applicants</p>
                                <p class="widget-numeric-value">{{ $total_job_request }}</p>
                            </div>
                        </div>
                        ...
                        <div class="reviews-body text-center">
                            <div class="row">
                                <div class="col-md-6 col-6">                                                    
                                    ...
                                    <img alt="emoji" class="icon-positive mt-2" src="{{asset('public/admin/assets/img/simple-smile.png')}}">
                                    <p class="r-positive-percentage mb-0 mt-4">78%</p>
                                </div>
                                <div class="col-md-6 col-6">                                                    
                                    <p class="r-negative-txt">Negative</p>
                                    <img alt="emoji" class="icon-positive mt-2" src="{{asset('public/admin/assets/img/simple-sad-smile.png')}}">
